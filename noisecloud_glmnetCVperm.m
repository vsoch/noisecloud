function RESULT = noisecloud_glmnetCVperm(X,y,K,Lambda,alphav,type)
...
% Save sensitivity and specificity to plot
RESULT.sens = aroc_sens; 
RESULT.spec = aroc_spec;
...
% Evaluate(ACTUAL,PREDICTED) returns EVAL = [accuracy sensitivity specificity precision recall f_measure gmean tp tn fp fn]
RESULT.EVAL = Evaluate(evallabels,Ypredicty);
RESULT.actual = evallabels;        
RESULT.predict = Ypredicty;
